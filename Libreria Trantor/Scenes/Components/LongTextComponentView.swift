...
struct LongTextComponentView: View {
    ...
    var body: some View {
        VStack (spacing:0){
            Text(.init(longText.htmlToMarkDown()))
                .font(.body)
